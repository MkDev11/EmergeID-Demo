...
export abstract class BaseWalletAPI {
  ...
  async getCounterFactualAddress(): Promise<string> {
    try {
      ...
      // For newer versions of the entrypoint, the address is returned
      // in an error
      const iface = new ethers.utils.Interface(['error SenderAddressResult(address sender)'])
      const parsedError = iface.parseError(err.data)
      return parsedError.args.sender
    }
  }
